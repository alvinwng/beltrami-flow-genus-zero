function mu_diff=compute_beltrami_differential(pt1,pt2,tri,outward)

% Alvin Wong, October 10, 2012

% Compute the Beltrami differential of a mesh map.
% pt1: n by 3 or n by 2
...
%     mu_diff(i)=(M(1,1)-M(2,2)+sqrt(-1)*(M(2,1)+M(1,2)))/(M(1,1)+M(2,2)+sqrt(-1)*(M(2,1)-M(1,2)));
% end
